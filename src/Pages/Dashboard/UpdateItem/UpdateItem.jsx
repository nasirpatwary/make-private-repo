...
const UpdateItem = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (res.data.success) {
            ...
            const menuRes = await axiosSecret.patch(`/menu${_id}`, menuItem)
            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-control">
                        ...
                        <textarea className="textarea textarea-bordered h-24" defaultValue={recipe} {...register('recipe')} placeholder="Recipe Details"></textarea></div>

                    <div className="form-control w-full my-5">
                        <input {...register('image', { required: true })} type="file" className="file-input w-full max-w-xs" />
                    </div>
                    <button className="btn btn-outline bg-sky" >Update menu Item<FaUtensils></FaUtensils>
                    </button>
                </form>
            </div>
        </div>
